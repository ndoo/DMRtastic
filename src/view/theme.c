...
/* VS Code "Dark High Contrast" anchors (hcDark workbench defaults from hc_black.json +
 * colorRegistry.ts fallbacks). Unlike the old "2026 Dark" palette, editor.background is already
 * pure black, so no manual clamp needed.
 */
