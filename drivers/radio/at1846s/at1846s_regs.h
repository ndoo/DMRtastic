...
static const struct at1846s_reg_entry at1846s_init_regs[] = {
	...
	AT1846S_DELAY_MS(50),
	{ 0x30, 0x00, 0x04 },           /* power on */
	{ 0x04, 0x0F, 0xD0 },           /* clock mode (26 MHz xtal) */
	{ 0x0A, 0x7C, 0x20 },
	{ 0x13, 0xA1, 0x00 },
	{ 0x1F, 0x10, 0x01 },           /* GPIO6 = squelch out, GPIO1 = CSS out */
	{ 0x31, 0x00, 0x31 },
	...
	{ 0x54, 0x2A, 0x3C },
	{ 0x55, 0x00, 0x81 },
	{ 0x56, 0x0B, 0x02 },           /* SQ detect timing */
	{ 0x57, 0x1C, 0x00 },           /* bypass RSSI LPF */
	{ 0x58, 0x9C, 0xDD },           /* filter custom setting */
	{ 0x5A, 0x06, 0xDB },
	{ 0x63, 0x16, 0xAD },           /* pre-emphasis bypass threshold */
	{ 0x0F, 0x8A, 0x24 },
	{ 0x05, 0x87, 0x63 },
	{ 0x30, 0x40, 0xA4 },           /* prepare for calibration */
	{ 0x30, 0x40, 0xA6 },           /* enable calibration */
	AT1846S_DELAY_MS(100),
	{ 0x30, 0x40, 0x06 },           /* disable calibration */
	AT1846S_DELAY_MS(10),
};
...
static const struct at1846s_reg_entry at1846s_mode_fm_regs[] = {
	...
	{ 0x42, 0x10, 0xF0 },
	{ 0x43, 0x00, 0xA9 },
	{ 0x58, 0x9C, 0x85 },           /* FM filters; de-emphasis on AT1846S */
	{ 0x44, 0x06, 0xCC },           /* internal volume 80% */
	{ 0x3A, 0x00, 0xC3 },
	{ 0x40, 0x00, 0x30 },           /* low-freq audio path */
};
