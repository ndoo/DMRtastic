...
#define HRC6000_36_FM_FEED_ON                                                                      \
	0x02 /* enable FM audio feedthrough (IF demod -> codec -> speaker amp) */
...
static const struct hr_c6000_reg_pair hr_c6000_init_setup_regs[] = {
	...
	{0x10, 0xF3}, {0x5F, 0xF0}, /* enable sync detect MS/BS/TDMA1/TDMA2 */
...
static const uint8_t hr_c6000_init_ctrl_0x11_array[] = {
	0x80, 0x0C, 0x22, 0x01, 0x00, 0x00, 0x33, 0xEF, 0x00, 0xFF, 0xFF, 0xFF, 0xF0, 0xF0, 0x10,
	0x00, 0x00, 0x06, 0x3B, 0xF8, 0x0E, 0xFD, 0x40, 0xFF, 0x00, 0x0B, 0x00, 0x00, 0x00, 0x06,
	0x0B, 0x00, 0x17, 0x02, 0xFF, 0xE0, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
...
static const uint8_t hr_c6000_init_aux_0x10_array[] = {
	0x69, 0x69, 0x96, 0x96, 0x96, 0x99, 0x99, 0x99, 0xA5, 0xA5, 0xAA,
	0xAA, 0xCC, 0xCC, 0x00, 0xF0, 0x01, 0xFF, 0x01, 0x0F, 0x00, 0x00,
...
static const struct hr_c6000_reg_pair hr_c6000_init_aux_more_regs[] = {
	{0x52, 0x08}, {0x53, 0xEB}, {0x54, 0x78}, {0x45, 0x1E}, {0x37, 0x50}, {0x35, 0xFF},
};

/* ---- Init table: late page-0x04 setup (codec + interrupts) ---------- */

static const struct hr_c6000_reg_pair hr_c6000_init_late_regs[] = {
	{0x39, 0x02}, {0x3D, 0x0A}, {0x83, 0xFF},               /* clear interrupts */
	{0x87, 0x00},                                           /* interrupt masks */
	{0x65, 0x0A}, {0x1D, 0xFF},                             /* unaddress mask */
	{0x1E, 0xF1},                                           /* broadcast address */
	{0xE2, 0x06},                                           /* configure codec */
	{0xE4, 0x27},                                           /* mic gain */
	{0xE3, 0x52},                                           /* codec defaults */
	{0xE5, 0x1A}, {0xE1, 0x0F}, {0xD1, 0xC4}, {0x25, 0x0E}, /* DAC power control */
	{0x26, 0xFD},                                           /* ADC control */
	{0x64, 0x00}, {0x10, 0x6B}, /* DMR Tier2, Slot1, Repeater, Aligned */
	{0x81, 0x19}, {0x01, 0xF0}, {0xE4, 0x27}, {0xE5, 0x1A},
	{0x37, 0x9E}, {0xE0, 0xC9},               /* codec under MCU control, lineout2 + mic_p */
	{0x25, 0x0E}, {0x26, 0xFD}, {0x48, 0x00}, /* ref-osc calibration offsets — placeholder */
	{0x47, 0x21}, {0x1F, 0x10},               /* CC1 = 1 */
};

/* ---- Init table: aux page-1 cleanup writes -------------------------- */

static const struct hr_c6000_reg_pair hr_c6000_init_aux_cleanup_regs[] = {
	{0x54, 0x78}, {0x24, 0x00}, {0x25, 0x00}, {0x26, 0x00}, {0x27, 0x00},
};
