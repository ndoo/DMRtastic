...
#
# Vendored verbatim from Zephyr 4.4.0 (framework-zephyr, matching the
# `platform = ststm32@19.6.0` pin in platformio.ini), the same script
# Zephyr's own CI runs for C/H and devicetree style compliance. Refresh from
# ~/.platformio/packages/framework-zephyr/scripts/checkpatch.pl if that pin
# changes.
